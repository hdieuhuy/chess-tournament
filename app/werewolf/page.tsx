...
import { getNextNightPhase, checkWinCondition } from "./gameLogic";
  ...
  useEffect(() => {
    ...
    roomChannel
        ...
        if (state.hostName === playerName) {
          ...
          roomChannel.send({
            ...
            payload: {
              ...
              whiteWolfVictim: state.whiteWolfVictim,
      ...
      .on("broadcast", { event: "room-sync" }, (payload) => {
        ...
        if (data.whiteWolfVictim !== undefined)
          updates.whiteWolfVictim = data.whiteWolfVictim;
          ...
          payload: (prev) => ({
            ...
            wolfVictim:
              role === "cursed_wolf" && target
                ...
                : prev.wolfVictim,
            whiteWolfVictim:
              role === "white_wolf" ? target : prev.whiteWolfVictim,
            headhunterTarget:
            ...
            hypnotizedPlayers:
              role === "pied_piper" && target
                ? [...new Set([...prev.hypnotizedPlayers, target])]
                : prev.hypnotizedPlayers,
          }),
        });
      })
            ...
            <div>
              ...
              <div className="space-y-3">
                {(() => {
                  ...
                  const formatLogContentModal = (content: string) => {
                                ...
                                >
                                  ...
                                  >
                                    ...
                                    {log.playerName !== "system"
                                      ? `(${log.playerName}${log.playerName === playerName ? " - Bạn" : ""})`
                                      : ""}
                                  </span>
                                  <p className="mt-1 text-zinc-700">
                                    {formatLogContentModal(log.content)}
                                  </p>
                                </div>
                              );
                            })}
          ...
          <div className="flex w-full flex-col space-y-6">
            ...
            {phase === "night" && alivePlayers.includes(playerName) && (
              <div className="flex flex-col items-center rounded-xl border border-indigo-900/50 bg-slate-800/80 p-6 shadow-sm md:items-start">
                ...
                playerRoles[playerName]?.id === "fool" ? (
                  ...
                  playerRoles[playerName]?.id !== "pied_piper" ? (
            ...
            {(() => {
              const isWolf =
                ...
                playerRoles[playerName]?.id === "white_wolf";
              const isLover = !!(
